                ...
                <tbody class= "text-muted">
                  @foreach(auth()->user()->assignments as $assignment)
                    <tr>
                      ...
                      <td>{{$assignment->tasks->description}}</td>
                      <td>{{$assignment->tasks->provision}}</td>
                      <td>
                           <a href="/get/my/task/{{$assignment->id}}" class="btn btn-primary btn-sm">Open</a>
                      </td>
                    </tr>
                  @endforeach  
                </tbody>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Scope</label>
