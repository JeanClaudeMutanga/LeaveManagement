    ...
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          ...
          <a href="#NewApplication" data-target="#NewApplication" data-toggle="modal" class="btn btn-primary btn-md mt-4">Submit Application</a>
          <hr>
      ...
      <!---Modal--->
      <div class="modal fade" id="NewApplication" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Leave Application Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/submit/application" method="POST">
                    @csrf

                       <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Leave Type</label>

                            <div class="col-sm-12">
                                <select class="custom-select" id="inputGroupSelect02" name="leaves_id" required>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Leave Title</label>

                            <div class="col-sm-12">
                                   <input class="form-control" type="text" name="title" id="name">
                                   <input type="hidden" name="user_id" value ="{{auth()->user()->id}}" id="name">
                                   <input type="hidden" name="decision" value ="Pending" id="name">
                            </div>
                        </div>


                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Proposed Start Date</label>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Proposed End Date</label>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Notes</label>

                            <div class="col-sm-12">
                                   <textarea class="form-control" name="notes" id="notes" cols="30" rows="10" placeholder="Optional"></textarea>
                            </div>
                        </div>
