...
<head>
  ...
  <title>Task | {{$assignment->tasks->name}}</title>
...
<body>
  ...
  @include('layouts.messages')
    ...
    <a href="/my/tasks" class="btn btn-primary offset-2 mb-2">Back</a>
      <div class="container">
      
        <div class="row no-gutters">
          <div class="col-lg-6 video-box mt-5"> 
          <div class="">
                <h5 class="text-success"><strong>Task Details</strong></h5>
              <h4 class="text-primary"><strong>{{$assignment->tasks->name}}</strong></h4>
              <p><strong>Scope :</strong> {{$assignment->tasks->type}}</p>

            </div>

            <div class="" data-aos="fade-up" data-aos-delay="100">
              <h4 class="title text-primary"></h4>
              <p class="description"><strong>Status :</strong> <button class="btn btn-success">
                  @if($assignment->tasks->status == 100)
                  Completed
                  @elseif($assignment->tasks->status > 0)
                  In Progress
                  @else
                  Not Started
                  @endif
            ...
            <div class="" data-aos="fade-up" data-aos-delay="100">
              <h4 class="title text-primary"></h4>
              <p class="description"><strong>Provision :</strong> {{$assignment->tasks->provision}}</p>
            </div>


            <div class="" data-aos="fade-up" data-aos-delay="100">
              <h4 class="title text-danger"><h4 class="text-danger"></h4></h4>
              <p class="description"> <strong>Assigned:</strong> {{$assignment->created_at->diffForHumans()}} On {{$assignment->created_at}} </p>
            </div>
          ...
          <div class="col-lg-6 mt-5 d-flex">
            ...
            <div class="col-lg-4">
              <div class="">
                  <h5 class="text-success"><strong>Description</strong></h5>
                  <p class="">{{$assignment->tasks->description}}</p>
              </div>
            ...
            <div class="col-lg-2">
              <div class="dropdown show">
                  <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Task Actions</a>
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="background-color:blue;">
                        <a class="dropdown-item" href="/start">Start</a>
                        <a class="dropdown-item" href="/outgoing/referrals">Hold</a>
                        <a class="dropdown-item" href="/outgoing/referrals">Stop</a>
                        <a class="dropdown-item" href="/outgoing/referrals">Finish</a>
                      </div>
                </div>
            </div>
            --->
    ...
    <div class="container">
      <h5><strong class="text-primary">Progress</strong></h5>
      <div class="progress">
          <div class="progress-bar" role="progressbar" style="width: {{$assignment->tasks->status}}%" aria-valuenow="{{$assignment->tasks->status}}" aria-valuemin="0" aria-valuemax="100">{{$assignment->tasks->status}}%</div>
      </div>
    </div>
  

        @if($assignment->tasks->todo == "Yes")
          <section id="about" class="about">
          <div class="container">
              ...
              <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
                ...
                <div class=" mb-2">
                    <div class="d-flex justify-content-between">
                      <h2><strong class="text-muted">Todos</strong></h2>
                    </div>
                </div>
              
                <div class="icon-box" data-aos="fade-up" data-aos-delay="100">  
                  <p class="text-center"><strong>Todo Progress</strong></p>
                </div>

                <table class="table text-muted responsive">
                    <thead>
                        <tr>
                    ...
                    @foreach($assignment->tasks->todos as $todo)
                        <tr>
                          <td>{{$todo->title}}</td>
                          ...
                          <td>
                              @if($assignment->tasks->status == 100)
                              <a href="/complete/task/{{$todo->id}}" class="disabled btn btn-primary btn-sm">Done</a>
                              @else
                              <a href="/complete/task/{{$todo->id}}" class="btn btn-primary btn-sm">Done</a>
                              @endif
                          </td>
                        </tr>
                        @endforeach
        ...
        @elseif($assignment->tasks->todo == "No")
        <section id="about" class="about">
          <div class="container">
            ...
            <div class="row no-gutters">
              ...
              <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
                ...
                <div class=" mb-2">
                    <div class="d-flex justify-content-between">
                      <h2><strong class="text-muted">Task Progress</strong></h2>
                    </div>
                </div>
              
                <div class="icon-box" data-aos="fade-up" data-aos-delay="100">  
                  <p class="text-center"><strong>Update Progress</strong></p>
                </div>
                <a href="#UpdateMyProgress" data-toggle="modal" class="text-center btn-primary btn-lg">Update Progress</a>
              </div>
            </div>
     ...
     <!---Modal--->
     <div class="modal fade" id="UpdateMyProgress" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content text-muted">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Update Progress</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/update/custom/{{$assignment->tasks->id}}" method="POST">
                    @csrf

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Current Progress : {{$assignment->tasks->status}}%</label>

                            <div class="col-sm-12">
                                   <input class="" type="range" name="current" id="current" value="{{$assignment->tasks->status}}" style="width:430px;">
                                   <input type="hidden" name="assignment" value={{$assignment->id}}>
                                   <p>Update To : <span id="demo"></span>%</p>
                            </div>
                        </div>
        ...
        <div class="container">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
              ...
              <div class=" mb-2">
                  <div class="d-flex justify-content-between">
                    <h2><strong class="text-muted">Updates</strong></h2>
                  </div>
              </div>
            
              <div class="icon-box" data-aos="fade-up" data-aos-delay="100">  
                <p class="text-center"><strong>Progress Updates</strong></p>
              </div>
              ...
              <table class="table text-muted responsive">
                  ...
                  <tbody class= "text-muted">
                  @foreach(auth()->user()->updates->where('tasks_id',$assignment->tasks->id) as $update)
                      <tr>
                        <td>{{$update->user->name}}</td>
                        <td>{{$update->tasks->name}}</td>
