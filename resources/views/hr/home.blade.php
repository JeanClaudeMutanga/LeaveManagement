...
<body>
  ...
  <h4 class="text-center"><strong class="text-muted">Admin Dashboard</strong></h4>
        ...
        <div class="row" style="margin-top:50px;">
          ...
          <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up">
            ...
            <div class="icon"><i class='bx bxs-folder-open' style="color: blue;"></i></div>
              <h5 class="text-muted">{{$users->where('type',"employee")->count()}}</h5>
              <a href="/employees"><p>Employees</p></a>
            </div>
          </div>
    ...
    <hr class="col-md-8">
    <h4 class="text-center"><strong class="text-muted">Leave Types</strong></h4>
      ...
      <div class="container">
        ...
        @if($leaves->count()==0)
         <div class="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="600">
            <div class="count-box">
              <i class="bx bxs-folder-open" style="color:blue;"></i>
              <p class="text-muted">No Leaves Found</p>
              <a href="/admin/leaves"><p>Create New</p></a>
            </div>
          </div>
         @else
        ...
        <div class="col-lg-2 col-md-6 text-center" data-aos="fade-up" data-aos-delay="600">
            <div class="count-box rounded-circle mt-1">
              <a href="/admin/leaves"><i class="bx bxs-folder-plus" style="color:blue; height:55px;"></i></a>
              <a href="/admin/leaves"><p>Add New</p></a>
            </div>
          </div>
        @endif
