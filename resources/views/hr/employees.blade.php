  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <input type="text" name="search" id="search" class="form-control" placeholder="Search Employee By Name">
          <hr> 
          <a href="#NewUser" data-target="#NewUser" data-toggle="modal" class="btn btn-primary btn-md">Add User</a>
                ...
                <tbody class= "text-muted">
                  @foreach($users as $user)
                    <tr>
                      ...
                      <td>
                        <a href="/get/employee/{{$user->id}}" class="btn btn-success btn-sm">Open</a>
                      </td>
                    </tr>
                  @endforeach  
                </tbody>
