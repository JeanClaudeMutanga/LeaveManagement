...
<body>
  ...
  @include('layouts.messages')
    ...
    <a href="/admin/applications/{{$application->leaves_id}}" class="btn btn-primary offset-2 mb-2">Back</a>
      <div class="container">
      
        <div class="row no-gutters">
          <div class="col-lg-6 video-box mt-5"> 
          <div class="">
                <h5 class="text-success"><strong>Applicant Details</strong></h5>
              <h4 class="text-primary"><strong>{{$application->user->name}}</strong></h4>
           ...
           <div class="" data-aos="fade-up" data-aos-delay="100">
              ...
              <h4 class="title text-danger"><h4 class="text-danger"></h4></h4>
              <p class="description">Applications: {{$application->user->applications->count()}}</p>
            </div>
          </div>
          ...
          <div class="col-lg-6 mt-5 d-flex">
            ...
            <div class="col-lg-4">
              <div class="">
                  <h5 class="text-success"><strong>Application</strong></h5>
                  <h4 class="text-primary">Title: <strong>{{$application->title}}</strong></h4>
              </div>
              ...
              <div class="" data-aos="fade-up" data-aos-delay="100">
                <h4 class="title text-primary"></h4>
                <p class="description">Duration: <h5><strong class="text-primary">{{$application->duration}} Days</strong></h5> </p>
                <p class="description">Status: <h4><strong class="text-primary">{{$application->decision}}</strong></h4> </p>
              </div>
            </div>

            <div class="col-lg-2">
                <a href="/approve/application/{{$application->id}}" class=" btn btn-success btn-md" style="color: white;">Approve</a>
                <a href="#RejectApplication" data-target="#RejectApplication" data-toggle="modal" class=" mt-3 btn btn-danger btn-md" style="color: white;">Reject</a>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">More Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/reject/application/{{$application->id}}" method="POST">
                    @csrf

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Rejection Notes</label>

                            <div class="col-sm-12">
                                   <textarea class="form-control" name="decision_notes" id="notes" cols="30" rows="8" placeholder="Optional"></textarea>
                            </div>
                        </div>


                        <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-primary" id="saveBtn" value="create">Reject
                        </button>
                        </div>
                    </form>
                </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
            ...
            <table class="mt-3 text-muted responsive">
                ...
                <tbody class= "text-muted">
                    <tr>
                      <td>{{$application->decision_notes}}</td>
                    </tr>
                </tbody>
            </table>
