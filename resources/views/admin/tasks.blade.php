  ...
  <!----Dashboard Section------>
    <section class="counts section-bg">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
          <input type="text" name="search" id="search" class="form-control" placeholder="Search Task Name">
          <a href="#NewTask" data-target="#NewTask" data-toggle="modal" class="btn btn-primary btn-md mt-4">Create Task</a>
          <hr>
                ...
                <tbody class= "text-muted">
                  @foreach(auth()->user()->tasks as $task)
                    <tr>
                      ...
                      <td>{{$task->provision}}</td>
                      <td>{{$task->type}}</td>
                      <td>
                          <a href="/admin/get/task/{{$task->id}}" class="btn btn-primary btn-sm">Open</a>
                      </td>
                    </tr>
                  @endforeach  
                </tbody>
      ...
      <!---Modal--->
      <div class="modal fade" id="NewTask" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content ">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Task Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/create/tasks" method="POST">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                   ...
                                   <input type="hidden" name="status" value ="0" id="name">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <select class="custom-select" id="inputGroupSelect02" name="type" required>
                                    ...
                                    <option value="Solo">Single Person Task</option>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Include Todo?</label>

                            <div class="col-sm-12">
                                <select class="custom-select" id="inputGroupSelect02" name="todo" required>
                                    <option value="">Choose...</option>
