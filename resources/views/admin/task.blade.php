...
<body>
  ...
  @include('layouts.messages')
    ...
    <a href="/admin/tasks" class="btn btn-primary offset-2 mb-2">Back</a>
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="">
              ...
              <h4 class="text-primary"><strong>{{$task->name}}</strong></h4>
              <p><strong>Type :</strong> {{$task->type}}</p>
            </div>

            <div class="" data-aos="fade-up" data-aos-delay="100">
              <h4 class="title text-primary"></h4>
              <p class="description"><strong>Provision :</strong> {{$task->provision}}</p>
            </div>


            <div class="" data-aos="fade-up" data-aos-delay="100">
              <h4 class="title text-danger"><h4 class="text-danger"></h4></h4>
              <p class="description"> <strong>Employees Assigned:</strong> {{$task->assignments->count()}}</p>
            </div>
          ...
          <div class="col-lg-6 mt-5 d-flex">
            ...
            <div class="col-lg-2">
                <a href="#RejectApplication" data-target="#RejectApplication" data-toggle="modal" class=" mt-3 btn btn-primary btn-md" style="color: white;">Assign</a>
            </div>
          </div>
        </div>
     ...
     <!---Modal--->
     <div class="modal fade" id="RejectApplication" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Choose Employee</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/task/assign/{{$task->id}}" method="POST">
                    @csrf

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Choose Assignee</label>

                            <div class="col-sm-12">
                                   <select class="form-control" name="user_id" id="user_id" required>
                                      <option value="">Choose</option>
                                      @foreach($users->where('manager',auth()->user()->id) as $user)
              ...
              <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
                ...
                <div class=" mb-2">
                    <div class="d-flex justify-content-between">
                      ...
                      <a href="#NewTodo" data-toggle="modal" class="btn btn-primary btn-sm">New Todo</a>
                    </div>
                </div>
              
                <div class="icon-box" data-aos="fade-up" data-aos-delay="100">  
                  <p class="text-center"><strong>Task Todos</strong></p>
        ...
        <!---Modal--->
     <div class="modal fade" id="NewTodo" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelHeading">Todo Details</h4>
                </div>
                <div class="modal-body">
                    <form id="CustomerForm" name="CustomerForm" class="form-horizontal" action ="/create/todo/{{$task->id}}" method="POST">
                    @csrf

                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Title</label>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Description</label>
                        ...
                        <div class="form-group">
                            <label for="type" class="col-sm-12 control-label">Due Date</label>

                            <div class="col-sm-12">
                                   <input class="form-control" type="date" name="due" id="due">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                   <input class="form-control" type="hidden" name="tasks_id" value="{{$task->id}}" id="title">
                                   <input class="form-control" type="hidden" name="status" value="Pending" id="title">
                            </div>
      ...
      <div class="container">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
            ...
            <div class=" mb-2">
                <div class="d-flex justify-content-between">
                  <h2><strong class="text-muted">History</strong></h2>
                </div>
            </div>
          
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">  
               <p class="text-center"><strong>Update History</strong></p>
            </div>
