...
<head>
  ...
  <link href="/custom/css/sb-admin-2.min.css" rel="stylesheet">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/admin/get/leaves">Leave Type</a>
            <a class="collapse-item" href="/admin/get/applications">Leave Applications</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Options</h6>
            <a class="collapse-item" href="/admin/tasks">Tasks</a>
            <a class="collapse-item" href="#NewTask">New Task</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Work Force Management:</h6>
            <a class="collapse-item" href="/allocated/all">Work Force</a>
            <a class="collapse-item" href="login.html">Add New</a>
            <!--
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Leaves Types</div>
            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                @foreach($tasks->where('user_id',auth::user()->id) as $task)
                  <h4 class="small font-weight-bold">{{$task->name}} <span class="float-right">{{$task->status}}%</span></h4>
                  <div class="progress mb-4">
                  @if($task->status <= 49)
                    <div class="progress-bar bg-danger" role="progressbar" style="width: {{$task->status}}%" aria-valuenow="{{$task->status}}" aria-valuemin="0" aria-valuemax="100"></div>
                  @else
                    <div class="progress-bar bg-success" role="progressbar" style="width: {{$task->status}}%" aria-valuenow="{{$task->status}}" aria-valuemin="0" aria-valuemax="100"></div>
                  @endif
                  </div>
                @endforeach
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Leave Management </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn btn-success btn-secondary" type="button" data-dismiss="modal">Cancel</button>
