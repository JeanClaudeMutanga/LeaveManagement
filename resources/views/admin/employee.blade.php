...
<body>
  ...
  @include('layouts.messages')
    ...
    <a href="/allocated/all" class="btn btn-primary offset-2 mb-2">Back</a>
      <div class="container">
          ...
          <div class="col-lg-12 d-flex flex-column justify-content-center about-content">
            ...
            <div class=" mb-2">
                <div class="d-flex justify-content-between">
                  <h2><strong class="text-muted">Inventory</strong></h2>
                </div>
            </div>
            ...
            <p class="text-center text-muted">Allocated Tasks</p>
